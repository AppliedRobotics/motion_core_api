...
def main():
    ...
    jpos_1 = Waypoint(
        [math.radians(0.0), math.radians(0.0), math.radians(90.0),
         math.radians(0.0), math.radians(90.0), math.radians(0.0)], 0.5, 0.1)
    jpos_2 = Waypoint(
        [math.radians(0.0), math.radians(0.0), math.radians(0.0),
         math.radians(0.0), math.radians(0.0), math.radians(0.0)], 0.1, 0.5)
    jpos_3 = Waypoint(
        [math.radians(15.0), math.radians(0.0), math.radians(0.0),
         math.radians(0.0), math.radians(0.0), math.radians(0.0)], 1.0, 0.5)
    jpos_4 = Waypoint(
        [math.radians(15.0), math.radians(0.0), math.radians(90.0),
         math.radians(0.0), math.radians(90.0), math.radians(0.0)], 0.5, 0.0)

    # waypoint move
    motion_pr_2 = MotionProgram(req, motorcortex_types)
    motion_pr_2.addMoveJ([jpos_1, jpos_2, jpos_3, jpos_4], 1.0, 1.0)
